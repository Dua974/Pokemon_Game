 ...
 **In this "Pokemon.h" file, a Pokemon class is declared with various member functions serving as setters and getters for different attributes of a Pokemon.
 **These functions allow access to and modification of the Pokemon's combat power (CP), rarity, name, and number.These member functions collectively facilitate the manipulation and retrieval of Pokemon
 **attributes,            
