 ...
 **                                                                                               
 **It defines the Game class, which serves as the core engine of the game. This class manages various game features, including loading Pokemon data from a file, displaying the PokeDex and the player's
 **team, catching new Pokemon, training existing ones, and engaging in battles. The file also contains constants for game parameters such as rarity levels and CP values, along with necessary include
 **statements for input/output operations and string manipulation. Through its member functions, the Game class provides an interface for players to interact with the game, guiding them through the
 **process of exploring, capturing, and battling Pokemon within the game depeding on what option from the main menu the user inputs. . 
